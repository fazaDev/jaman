...
<section class="bg-gradient-to-r from-green-600 to-green-800 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center text-white">
            ...
            <p class="text-xl text-green-100">Dokumentasi kegiatan dan momen penting dalam gambar dan video</p>
        </div>
    </div>
</section>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex justify-center mb-8">
        <div class="flex space-x-1 bg-gray-100 p-1 rounded-lg">
            <a href="{{ route('gallery.index') }}" 
               class="px-6 py-2 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('gallery.index') ? 'bg-white text-gray-900 shadow' : 'text-gray-500 hover:text-gray-700' }}">
                Semua
            </a>
            <a href="{{ route('gallery.photos') }}" 
               class="px-6 py-2 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('gallery.photos') ? 'bg-white text-gray-900 shadow' : 'text-gray-500 hover:text-gray-700' }}">
                Foto
            </a>
            <a href="{{ route('gallery.videos') }}" 
               class="px-6 py-2 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('gallery.videos') ? 'bg-white text-gray-900 shadow' : 'text-gray-500 hover:text-gray-700' }}">
                Video
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="group cursor-pointer" data-modal-target="gallery-modal" data-item-id="{{ $item->id }}">
